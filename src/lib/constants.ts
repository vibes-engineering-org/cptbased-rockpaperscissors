export const PROJECT_TITLE = "RockPaperScissors";
export const PROJECT_DESCRIPTION = "Play classic Rock Paper Scissors game in Farcaster";
export const PROJECT_CREATOR = "cptbased";
